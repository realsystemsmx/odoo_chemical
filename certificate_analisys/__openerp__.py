...
##############################################################################
{
    "name" : "Chemical Product Certificates of Analisys",
    "version" : "0.0.1",
    ...
    "report_webkit"  ],
    "description": """
Module for chemical product certificates of analisys
======================================================

.. image:: /certificate_analisys/static/src/img/logo-realsystems.png
...
*Coded by: Carlos Enrique Contreras Vara
    ...
    """,
    "images" : [ "images/logo-realsystems.png" ],
    "init_xml" : [
...
#                     "wizard/risksticker_report_webkit_wizard.xml",                      	
                     "view/certificateanalisys_view.xml",                   
                    ],
    'application': True,
    "installable": True,
    "active": False
